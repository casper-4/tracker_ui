...
export const translations = {
  pl: {
    ...
    skill_color: "Kolor",
    skill_target: "Cel",
    aspect_detail_title: "Szczegoly aspektu",
    aspect_no_description: "Brak opisu aspektu.",
    aspect_completion: "Ukonczenie aspektu",
    aspect_last7_delta: "Zmiana 7d",
    aspect_avg_30d: "Srednia 30d",
    aspect_peak_30d: "Szczyt 30d",
    aspect_low_30d: "Minimum 30d",
    aspect_related_subskills: "Powiazane subumiejetnosci",
    aspect_no_subskills: "Brak subumiejetnosci dla tego aspektu.",
    subskill_detail_title: "Szczegoly subumiejetnosci",
    subskill_no_description: "Brak opisu subumiejetnosci.",
    subskill_level: "Poziom",
    subskill_completion: "Ukonczenie",
    subskill_belongs_aspect: "Aspekt",
    subskill_linked_quests: "Powiazane questy",
    subskill_no_quests: "Brak powiazanych questow.",
    color_custom: "Własny",
    color_confirm: "OK",
    color_back: "← Wróć",
  ...
  en: {
    ...
    skill_color: "Color",
    skill_target: "Target",
    aspect_detail_title: "Aspect Details",
    aspect_no_description: "No aspect description.",
    aspect_completion: "Aspect Completion",
    aspect_last7_delta: "7d Delta",
    aspect_avg_30d: "Avg 30d",
    aspect_peak_30d: "Peak 30d",
    aspect_low_30d: "Low 30d",
    aspect_related_subskills: "Related Subskills",
    aspect_no_subskills: "No subskills for this aspect.",
    subskill_detail_title: "Subskill Details",
    subskill_no_description: "No subskill description.",
    subskill_level: "Level",
    subskill_completion: "Completion",
    subskill_belongs_aspect: "Aspect",
    subskill_linked_quests: "Linked Quests",
    subskill_no_quests: "No linked quests.",
    color_custom: "Custom",
    color_confirm: "OK",
    color_back: "← Back",
